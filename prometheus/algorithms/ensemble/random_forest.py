...
__all__ = ["RF_model", "RF_model_inference"]
    ...
    **kwargs,
    ...
    if model_type == "regressor":
        algorithm = RandomForestRegressor(
            bootstrap=True, n_jobs=1, n_estimators=25, max_depth=13, min_samples_split=5
        )
        param = _parameter_input(X_train, **algo_kwargs)
        ...
        algorithm = BalancedRandomForestClassifier(
            bootstrap=True, n_jobs=1, class_weight=balanced_weights
        )
    ...
    if model_type == "regressor":
        ...
        # define scoring metric - regression
    ...
    if tuning_strategy == "RGS":  # Randomised Grid-search with CV
        ...
        raise ValueError(f"Search strategy {tuning_strategy} not supported!")
